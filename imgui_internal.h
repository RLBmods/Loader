...
//#endif
    ...
    IMGUI_API bool          News(ImTextureID texture_id, const char* label, const char* description, bool *notif_hide);
    IMGUI_API bool          Product(ImTextureID texture_id, const char* label, int* v, int number);
    IMGUI_API bool          Tab(const char* icon, const char* label, int* tab, int number);
